...
var Connection = function () {
	...
	_createClass(Connection, [{
		...
		key: 'send',
		value: function () {
			var _ref2 = _asyncToGenerator(regeneratorRuntime.mark(function _callee3(cmd) {
				var _this2 = this;
					...
					while (1) {
						switch (_context3.prev = _context3.next) {
							...
							case 3:
								...
								wrapped = _extends({}, result, { key: cmd.key });
								...
								throw new _error.Error(wrapped);
							...
							case 7:
								...
								throw new _error.Exception(wrapped);

							case 9:
								return _context3.abrupt('return', wrapped);
		...
		key: 'fire',
		value: function () {
			var _ref4 = _asyncToGenerator(regeneratorRuntime.mark(function _callee4(cmd) {
				var d;
				return regeneratorRuntime.wrap(function _callee4$(_context4) {
					while (1) {
						switch (_context4.prev = _context4.next) {
							case 0:
								d = Math.ceil(500, Math.random() * 2000);
		...
		key: 'dial',
		value: function dial(transport, host, delay) {
			var _this3 = this;

			var d = delay || Math.random() * 2000;
			if (this._closed) return;
			return transport.dial(host).then(function () {
				var _ref5 = _asyncToGenerator(regeneratorRuntime.mark(function _callee6(raw) {
				...
				var _ref7 = _asyncToGenerator(regeneratorRuntime.mark(function _callee7(ex) {
		...
		value: function read() {
			...
			return new Promise(function (resolve) {
				_this4._raw.on('data', function () {
					var _ref8 = _asyncToGenerator(regeneratorRuntime.mark(function _callee8(data) {
		...
		key: 'dial',
		value: function () {
			var _ref9 = _asyncToGenerator(regeneratorRuntime.mark(function _callee9(transport, protocol, host) {
				var raw;
